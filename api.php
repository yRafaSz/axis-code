...
function chat(): void {
    ...
    $profile = $classification['complexity'] === 'heavy'
        ? [0.15, 3200, 'medium', 54, 48]
        : ($classification['complexity'] === 'medium' ? [0.20, 2200, 'low', 52, 46] : [0.2, 900, 'none', 48, 42]);
    $payload = [
